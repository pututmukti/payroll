              ...
              <div class="row">
                ...
                <!-- Horizontal Form -->
                  <div class="box box-info">
                    <!-- form start -->
                    <form class="form-horizontal" method="get" action="{{url('')}}/laporanrekapitulasigaji">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            name="PERIODE_TRANSAKSI" data-date="10/11/2012" data-date-format="dd/mm/yyyy" value="{{$periodeTransaksi}}" placeholder="Tanggal Lahir">
                            </div>
                        </div>
                      </div>
                      <!-- /.box-body -->
                    ...
                    <div class="box-body">
                        <table id="example" class="table table-striped table-bordered table-hover dt-responsive">
                            <thead>
                                ...
                                <th class="none">Daftar Pegawai</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                ...
                var handleDemo1 = function () {
                    ...
                    grid.init({
                        ...
                        dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                            ...
                            "ajax": {
                                "type": "POST",
                                "data":{ _token : CSRF_TOKEN,areaOperasiCode:areaOperasiCode,areaOperasiName:areaOperasiName,lokasiKerjaCode:lokasiKerjaCode,lokasiKerja:lokasiKerja,periodeTransaksi:periodeTransaksi },
                                "dataType": "JSON",
                                "url": "laporanrekapitulasigajiinquiry" // ajax source
                            },
                            responsive: {
                                details: {
                                    type: 'column',
